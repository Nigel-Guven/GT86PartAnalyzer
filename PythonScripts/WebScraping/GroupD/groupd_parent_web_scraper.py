...
# Web Scrape
    while index < 3:
        ...
        page_header = 'https://group-d.ie'
        page_stem = '/collections/toyota-gt86?page=' + str(index)
        ...
        if response.status_code == 200:
            ...
            for child in parent_url_soup.find_all('a', href = True):
                ...
                if str(child).__contains__("collections/toyota-gt86/products"):
